  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">AlgoQuest?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than AlgoQuest, the premier programming community
          dedicated to helping new programmers achieve their goals and reach
          their full potential.
          <br />
          <br />
          Our Course List is a treasure trove of informative videos on
          ...
          <br />
          <br />
          At AlgoQuest, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But AlgoQuest is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With AlgoQuest by your side, there&apos;s nothing standing between
          ...
          <br />
          <br />
          So what are you waiting for? Join the AlgoQuest family today and
        ...
        <br />
        <span className="text-[22px]">Group Sixteen</span>
        <h5 className="text-[18px] font-Poppins">
          Developers of AlgoQuest
        </h5>
        <br />
        <br />
        <br />
